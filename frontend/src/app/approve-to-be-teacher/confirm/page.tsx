  ...
  return (
    <div className="h-screen grid grid-cols-4 gap-2 bg-[--white] place-items-center p-10">
      ...
      <div className="flex items-center justify-center w-full m-5 p-2">
        <p className="m-5 text-center align-middle">Notifica al nuevo instructor que le hemos enviado un correo de verificación de su nuevo rol en Poli Virtual</p>
        </div>
      </div>
    </div>
  );
